...
ARG VITE_ATLAS_PMTILES_URL
ENV VITE_ATLAS_PMTILES_URL=$VITE_ATLAS_PMTILES_URL
ARG VITE_ATLAS_PMTILES_GLYPHS_URL
ENV VITE_ATLAS_PMTILES_GLYPHS_URL=$VITE_ATLAS_PMTILES_GLYPHS_URL
